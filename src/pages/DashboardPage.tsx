        ...
        <div className={style.wrap}>
            <div className={style.block}>
                <div className={style.titleDescWrapper}>
                    ...
                    <p>This section displays a table of dialogs, allowing you to view and filter conversations.</p>
                </div>
                <div className={style.contentWrapper}>
                    <div className={style.filters}>
                        ...
                        <button className={style.resetButton} onClick={handleResetTableFilters}>Reset Table Filters</button>
                    </div>
            ...
            <div className={style.block}>
                ...
                <div className={style.contentWrapper}>
                    <div className={style.filters}>
                        ...
                        <button className={style.resetButton} onClick={handleResetChartFilters}>Reset Chart Filters</button>
                    </div>
